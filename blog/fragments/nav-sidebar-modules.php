                    ...
                    <div class="overflow-auto scrollbar-div pb-1" id="drag-to-scroll-cards" style="overflow: auto; ">
                        ...
                        <div class="card card-block mb-2">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row shadow-sm position-relative">
                                <div class="col py-2 px-4 d-flex flex-column position-static">
                                    <div class="just-center w-100">
                                        <a draggable="false" href="/Welders/blog/module-2" class="stretched-link mb-0 text-decoration-none black">
                        ...
                        <div class="card card-block mb-2">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row shadow-sm position-relative">
                                <div class="col py-2 px-4 d-flex flex-column position-static">
                                    <div class="just-center w-100">
                                        <a draggable="false" href="/Welders/blog/module-3" class="stretched-link mb-0 text-decoration-none black">
                        ...
                        <div class="card card-block mb-2">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row shadow-sm position-relative">
                                <div class="col py-2 px-4 d-flex flex-column position-static">
                                    <div class="just-center w-100">
                                        <a draggable="false" href="/Welders/blog/module-4" class="stretched-link mb-0 text-decoration-none black">
