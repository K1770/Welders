...
<body>
  ...
  <main class="container container2">
    ...
    <div class="py-1 text-center container ">
      <h2 class="fw-light">Module 4 - Topics</h2>
    </div>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3 justify-content-center ">
          ...
          <div class="col align-items-stretch justify-content-center card-module">
            <div class="card shadow-sm">
              <img class="card-img-top" src="_img/module4-topic1.jpg">

              <div class=" card-body text-center justify-content-center d-flex align-items-center">
                <p class="card-text fw-bold fs-5"><a href="topic1" class="stretched-link nice-link">Health and Safety prevention</a></p>
              </div>
            </div>
          </div> <!-- col end-->
          <div class="col d-flex align-items-stretch justify-content-center card-module">
            <div class="card shadow-sm">
              <img class="card-img-top" src="_img/module4-topic2.jpg">

              <div class="card-body text-center justify-content-center d-flex align-items-center">
                <p class="card-text fw-bold fs-5"><a href="topic2" class="stretched-link nice-link">The Wordskills Competition in Welding</a></p>
              </div>
            </div>
          </div> <!-- col end-->
